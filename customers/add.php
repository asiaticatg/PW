...
.btn-primary-custom:hover {
    background-color: #0f0d3a !important; /* versão mais escura opcional */
...
/* Ajuste de botão pequeno (se precisar em outras páginas) */
...
<form action="add.php" method="post">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-3">
            ...
            <input type="text" class="form-control" id="cpf" name="customer['cpf_cnpj']" maxlength="15">
        </div>
    ...
    <div class="row">
        <div class="form-group col-md-5">
            ...
            <input type="text" class="form-control" id="cidade" name="customer['city']" maxlength="100">
        </div>
